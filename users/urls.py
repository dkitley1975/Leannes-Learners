...
urlpatterns = [
    path('password/', views.PasswordUpdateView.as_view(), name='change-password'),
    ...
    path('edit-user-details', views.EditUserDetailsForm.as_view(), name='edit-user-details'),
    path('edit-profile/<int:pk>', views.EditUserProfile.as_view(), name='edit-profile'),
