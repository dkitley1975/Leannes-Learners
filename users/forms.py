...
class RegistrationForm(UserCreationForm):
    """
    Initialize the RegistrationForm class.
    This class is used to create a form for registering a new user.
...
class EditUserDetailsForm(UserChangeForm):
    """
    The form for editing the user details.
    This is used in the user profile page.
