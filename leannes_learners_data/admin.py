...
class ServiceAdmin(ImportExportModelAdmin, admin.ModelAdmin):
    """
    This is the admin page for the ImportExportModel.
    It allows the user to see the model's name,
...
class TermsAdmin(ImportExportModelAdmin, SummernoteModelAdmin):
    """
    The fields for the admin page for the ImportExportModelAdmin
    and the SummernoteModelAdmin.
    """
...
class TeachingHoursAdmin(ImportExportModelAdmin, admin.ModelAdmin):
    ...
    list_display = ("day", "start_time", "finish_time")
